...
urlpatterns = [
    ...
    path(
        "api/analyze/barcode/",
        api_views.api_analyze_barcode,
        name="api_analyze_barcode",
    ),
    ...
    path(
        "api/results/<int:pk>/", api_views.api_result_detail, name="api_result_detail"
    ),
    # API Docs
    ...
    path(
        "api/auth/profile/update/", auth_views.update_profile, name="api_update_profile"
    ),
    # Community
    path(
        "api/community/report/", community_views.submit_report, name="community_report"
    ),
    path(
        "api/community/score/<str:barcode>/",
        community_views.get_score,
        name="community_score",
    ),
    path(
        "api/community/my-vote/<str:barcode>/",
        community_views.my_vote,
        name="community_my_vote",
    ),
]
